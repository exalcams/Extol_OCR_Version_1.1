...
model7 = keras.models.load_model('po_model/po_7_TOKEN')
with open('po_model/po_7_TOKEN.pickle', 'rb') as handle:
        tokenizer7 = pickle.load(handle)
with open('po_model/po_token_7_TOKEN.pickle', 'rb') as enc:
        lbl_encoder7 = pickle.load(enc)
        
        
model5 = keras.models.load_model('po_model/po_5_TOKEN')

with open('po_model/po_5_TOKEN.pickle', 'rb') as handle:
        tokenizer5 = pickle.load(handle)
with open('po_model/po_token_5_TOKEN.pickle', 'rb') as enc:
        lbl_encoder5 = pickle.load(enc)
        
        
model9 = keras.models.load_model('po_model/po_9_TOKEN')

with open('po_model/po_9_TOKEN.pickle', 'rb') as handle:
        tokenizer9 = pickle.load(handle)
with open('po_model/po_token_9_TOKEN.pickle', 'rb') as enc:
