...
model7 = keras.models.load_model('ifsc/ifsc_7_TOKEN')
with open('ifsc/ifsc_7_TOKEN.pickle', 'rb') as handle:
        tokenizer7 = pickle.load(handle)
with open('ifsc/ifsc_token_7_TOKEN.pickle', 'rb') as enc:
        lbl_encoder7 = pickle.load(enc)
        
        
model5 = keras.models.load_model('ifsc/ifsc_5_TOKEN')

with open('ifsc/ifsc_5_TOKEN.pickle', 'rb') as handle:
        tokenizer5 = pickle.load(handle)
with open('ifsc/ifsc_token_5_TOKEN.pickle', 'rb') as enc:
        lbl_encoder5 = pickle.load(enc)
        
        
model9 = keras.models.load_model('ifsc/ifsc_9_TOKEN')

with open('ifsc/ifsc_9_TOKEN.pickle', 'rb') as handle:
        tokenizer9 = pickle.load(handle)
with open('ifsc/ifsc_token_9_TOKEN.pickle', 'rb') as enc:
...
def cleaner_for_nn(result):
	...
	text1=[x for x in text1.split() if len(x)>8 and len(x)<12]
	text1=[x for x in text1 if any(map(str.isalpha,x))==True]
	return text1
