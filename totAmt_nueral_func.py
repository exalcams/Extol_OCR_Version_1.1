...
model7 = keras.models.load_model('total/tot_7_TOKEN')
with open('total/tot_7_TOKEN.pickle', 'rb') as handle:
        tokenizer7 = pickle.load(handle)
with open('total/tot_token_7_TOKEN.pickle', 'rb') as enc:
        lbl_encoder7 = pickle.load(enc)
        
        
model5 = keras.models.load_model('total/tot_5_TOKEN')

with open('total/tot_5_TOKEN.pickle', 'rb') as handle:
        tokenizer5 = pickle.load(handle)
with open('total/tot_token_5_TOKEN.pickle', 'rb') as enc:
        lbl_encoder5 = pickle.load(enc)
        
        
model9 = keras.models.load_model('total/tot_9_TOKEN')

with open('total/tot_9_TOKEN.pickle', 'rb') as handle:
        tokenizer9 = pickle.load(handle)
with open('total/tot_token_9_TOKEN.pickle', 'rb') as enc:
