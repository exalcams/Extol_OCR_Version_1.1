...
model7 = keras.models.load_model('ac/ac_7_TOKEN')
with open('ac/ac_7_TOKEN.pickle', 'rb') as handle:
        tokenizer7 = pickle.load(handle)
with open('ac/ac_token_7_TOKEN.pickle', 'rb') as enc:
        lbl_encoder7 = pickle.load(enc)
        
        
model5 = keras.models.load_model('ac/ac_5_TOKEN')

with open('ac/ac_5_TOKEN.pickle', 'rb') as handle:
        tokenizer5 = pickle.load(handle)
with open('ac/ac_token_5_TOKEN.pickle', 'rb') as enc:
        lbl_encoder5 = pickle.load(enc)
        
        
model9 = keras.models.load_model('ac/ac_9_TOKEN')

with open('ac/ac_9_TOKEN.pickle', 'rb') as handle:
        tokenizer9 = pickle.load(handle)
with open('ac/ac_token_9_TOKEN.pickle', 'rb') as enc:
...
def cleaner_for_nn(result):
	...
	text1=[x for x in text1.split() if len(x)>8]
	text1=[x for x in text1 if all(map(str.isdigit,x))==True]
	return text1
